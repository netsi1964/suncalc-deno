...
const translations = {
  da: {
    ...
    fromShortest: 'Fra korteste dag',
    fromLongest: 'Fra længste dag',
  ...
  en: {
    ...
    fromShortest: 'From shortest day',
    fromLongest: 'From longest day',
  ...
  de: {
    ...
    fromShortest: 'Vom kürzesten Tag',
    fromLongest: 'Vom längsten Tag',    moonInfo: '🌙 Mondinformationen',
  ...
  es: {
    ...
    fromShortest: 'Del día más corto',
    fromLongest: 'Del día más largo',    moonInfo: '🌙 Información de la Luna',
